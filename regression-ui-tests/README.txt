...
FILES
  ...
  styles.css            All CSS styles (loaded by index.html).
  app.js                All JavaScript logic (loaded by index.html).
  test-data.js          Test case data as JS (loaded by index.html).
  test-cases.json       Test cases in JSON (generated by parser).
...
HOW TO UPDATE TEST CASES
  ...
  3. This re-parses the markdown and updates both
     test-cases.json and test-data.js.
